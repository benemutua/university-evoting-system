...
echo "-($nickname)";  ?>   <br> <br>                                      
<?php } ?>   
 <!-- end of search for presidential candidates-->  
...
echo $name ;?>   <br> <br>                                      
<?php } ?>   
 <!-- end of search for vice presidential candidates-->       
       </div>
...
echo $name;?>   <br> <br>                                      
<?php }?>        
<!-- end of search for sec gen candidates-->       
       </div>       
    </div> 
...
echo $name;?>   <br> <br>                                      
<?php }?>       
<!-- end of search for finance head candidates-->            
        </div>
...
echo $name;?>   <br> <br>                                      
<?php }?>        
<!-- end of search for ladies rep candidates-->            
        </div>
        <!--column 3-->
        <div class="colxx">
...
echo $name;?>   <br> <br>                                      
<?php }?>        
<!-- end of search for non residents rep candidates-->            
        </div>
    </div>
...
echo $name;?>   <br> <br>                                     
<?php }?>        
<!-- end of search for disabilities rep candidates-->            
        </div>
...
echo '<input type="radio" name="school_business" value=" '.$row['name'].' " >' ;     
echo '<img src="data:image;base64, '.base64_encode($row['image']).' " id="image" >';                           
echo $name;?>   <br> <br>                                     
<?php  }?> 
...
<font size="3" color="brown"><i class="icon-info-sign">denied</i></font>    
 <?php endif; }?>   
<!-- end of search for school rep candidates-->            
        </div>
...
echo '<input type="radio" name="school_education" value=" '.$row['name'].' " >' ;     
echo '<img src="data:image;base64, '.base64_encode($row['image']).' " id="image" >';                           
echo $name;?>   <br> <br>                                     
<?php  }?> 
...
echo '<input type="radio" name="school_engineering" value=" '.$row['name'].' " >' ;     
echo '<img src="data:image;base64, '.base64_encode($row['image']).' " id="image" >';                           
echo $name;?>   <br> <br>                                     
<?php  }?> 
...
echo '<input type="radio" name="school_humanities" value=" '.$row['name'].' " >' ;     
echo '<img src="data:image;base64, '.base64_encode($row['image']).' " id="image" >';                           
echo $name;?>   <br> <br>                                     
<?php  }?> 
...
echo '<input type="radio" name="school_hospitality" value=" '.$row['name'].' " >' ;     
echo '<img src="data:image;base64, '.base64_encode($row['image']).' " id="image" >';                           
echo $name;?>   <br> <br>                                     
<?php  }?> 

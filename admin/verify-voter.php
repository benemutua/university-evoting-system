...
$query = "SELECT * FROM voters WHERE name LIKE '%$valueToSearch%' OR admn_no LIKE '%$valueToSearch%' AND role='voter' ORDER BY id DESC";
    $result = filterTable($query);
}
else{
 $query = "SELECT * FROM voters WHERE role='voter' ORDER BY id DESC ";
    $result= filterTable($query);
...
<button type="submit" formaction="verify-voter.php" name="searchbtn" class="btn"><i class="fa fa-search">Search</i> </button>             
<button type="submit" name="bulk_verify_voter" class="btn"><i class="fa fa-group">Bulk Verify</i></button>
<button type="submit" name="print_selected" class="btn-reset" ><i class="fa fa-print">Print_selected</i></button>       
  ...
  <?php while ($row = mysqli_fetch_array($result)) { ?>
		<tr>
            ...
            <disable a href="#?verify_v=<?php echo $row['id']; ?>" class="edit_disabled" ><i class="fa fa-ban">Verified</i></a>
                <?php else: ?>
                <a href="votersdb.php?verify_v=<?php echo $row['id']; ?>"
